<header id="headerSesion">
    <div id="barraConSesion">
        ...
        if ($_SESSION["Invitado"] && !isset($_SESSION["Usuario"])) {
            echo '<div id="opcionesSinIniciar"><div><a href="#"><p>Iniciar Sesión</p></a></div><div><a href="registrar.php"><p>Registrarse</p></a></div></div>';
            ...
            echo '<div id="opcionesIniciado"> <div id="opcionUser"><a href="index.php" ><img src="../FnacImagenes/user.png"></a></div>
                ...
                <div id="opcionesUser"><form method="post" action="../Controlador/cerrarSesion.php"><input type="submit" name="cerrar_sesion" value="Cerrar Sesión"></form></div>
                <div id="market">
                <div id="atrasMarket">
                <img src="../FnacImagenes/flecha.png">             
                </div>
                <div id="EditarCarrito"><a href="ListaCompra.php"><h2>Editar Carrito</h2></a></div> 
                <div id="tituloMarket"><h1>Lista de productos</h1></div>
